...
# Load dataset
selected_columns = ["FZ", "SR", "SA", "V", "FX"]
df1 = pl.read_csv("train-combinedSlipLong.csv")
...
magic_parameters = {
    ...
    "combined_long_offset": 0.14428339898586273,
}
...
for epoch in range(cycles):
    ...
    if epoch % 100 == 0:
        ...
        json_filename = f"trainCache/fullslip_parameters_epoch_{epoch}.json"
...
json_filename = "full_slip_out.json"
with open(json_filename, "w") as json_file:
