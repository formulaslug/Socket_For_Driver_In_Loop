...
# Load dataset
df = pl.read_csv("train-combinedSlipLong.csv")
...
def getSlip(input_row, scalars):
    ...
    return curr.getLongForceCombinedSlip()
...
for epoch in range(cycles):
    ...
    if epoch % 100 == 0:
        ...
        json_filename = f"trainCache/comblongslipnew_parameters_epoch_{epoch}.json"
...
json_filename = "comblong_out.json"
with open(json_filename, "w") as json_file:
