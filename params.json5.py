// Base SI Units unless otherwise specified
{
    "Parameters": {
        "stepsPerSecond": 300,
        "simulationDuration": 40.0,
        "interpolationMethod": "linear", // "linear" or "cubic", this is for interpolating the simultion controls.

        "ambientTemperature": 20, // °C
        "tractiveIMax": 300, // A
        "initialBrakeTemperature": 20, // °C
        "initialBatteryTemperature": 20, // °C
        "vehicleSOC": 1.0, // Out of 1
        "initSpeed": 0.0, // m/s
        "initHeading": [1.0, 0.0, 0.0], // Vector pointing in the direction of the front of the car
        "initPosition": [0.0, 0.0, 0.0], // Starting position of the car in the world frame
        "initVelocity": [0.0, 0.0, 0.0], // Initial velocity vector in the world frame

        "airDensity": 1.230,
        "dragCoeffAreaCombo": 1.0858790012112278, // Combines area and drag coeff into one constant
        "rollingResistanceCoeff": 0.020926359062619436,

        "brakeDiscRadius": 0.09525, // meters (3.75 inches) -- Brake pad is ~1 inch wide near the edge of an 8 inch diamater rotor
        "brakeCaliperArea": 1.23, // in^2
